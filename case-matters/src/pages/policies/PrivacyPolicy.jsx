  ...
  return (
    <div className="min-h-screen bg-white py-24 px-6 md:px-12 lg:px-24 relative font-sans text-gray-600">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <motion.div key={item.id} variants={itemVariants} className="p-6 bg-gray-200/70 border border-gray-200/60 rounded-xl shadow-sm hover:border-gray-300 transition-all">
          ...
          <div className="space-y-4">
            {[
              ...
              <motion.div key={item.id} variants={itemVariants} className="flex gap-4 p-5 bg-gray-200/70 border border-gray-200/60 rounded-xl items-start">
                <div className="h-8 w-8 rounded-full bg-gray-300 flex items-center justify-center text-[#1871C9] font-bold text-xs flex-shrink-0">{item.id}</div>
          ...
          <motion.div variants={itemVariants} className="p-8 md:p-12 bg-gray-200/70 border border-gray-200/60 rounded-3xl">
            <h2 className="text-2xl font-serif font-bold text-gray-900 mb-6">10. Permitted Purposes</h2>
            <p className="text-sm text-gray-600 mb-6 italic underline decoration-[#1871C9]/30">Case Matters does not sell or rent Personal Information. Usage includes:</p>
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-gray-600 uppercase tracking-tight">
          ...
          <div className="space-y-4">
             <div className="bg-[#1871C9]/5 border border-[#1871C9]/20 p-6 rounded-2xl">
                <h3 className="font-bold text-gray-900 mb-2 uppercase text-xs tracking-widest">11 - 14. Consent & Legal Grounds</h3>
                <p className="text-sm text-gray-600">We process data based on client instructions, legal obligations, or express consent for marketing and newsletters. You may opt-out of marketing at any time.</p>
             </div>

             <div className="bg-gray-200/70 border border-gray-200/60 p-6 rounded-2xl">
                <h3 className="font-bold text-gray-900 mb-2 uppercase text-xs tracking-widest">15 - 17. Disclosure & Sharing</h3>
                <p className="text-sm text-gray-600">Information may be shared between Case Matters entities, with clients during service provision, with fraud prevention agencies, or when required by courts and regulators.</p>
             </div>

             <div className="bg-gray-300 text-gray-700 p-6 rounded-2xl">
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
            <div className="p-8 bg-gray-200/70 border border-gray-200/60 rounded-3xl shadow-sm">
                <AlertCircle className="text-[#1871C9] mb-4" />
                <h4 className="font-serif font-bold text-gray-900 text-xl mb-3">Your Data Rights</h4>
            ...
            <div className="p-8 bg-gray-200/50 border border-gray-200/60 rounded-3xl backdrop-blur-sm">
                <Mail className="text-[#1871C9] mb-4" />
                <h4 className="font-serif font-bold text-gray-900 text-xl mb-3">Feedback & Concerns</h4>
                <p className="text-sm text-gray-600 leading-relaxed">
        ...
        {/* Footer Text */}
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="mt-20 text-center border-t border-gray-200 pt-10">
          <p className="text-xs text-gray-500 uppercase tracking-widest mb-4">Case Matters LLP • DLF Almeda, Gurgaon</p>
