    ...
    <div className="min-h-screen bg-white py-24 px-6 md:px-12 lg:px-24 relative font-sans text-gray-600">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <motion.div variants={containerVars} initial="hidden" animate="visible" className="space-y-8">
          <motion.div variants={itemVars} className="p-8 bg-gray-200/70 border border-gray-200/60 rounded-3xl shadow-sm border-l-4 border-l-[#1871C9] backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div variants={itemVars} className="p-6 bg-gray-200/70 border border-gray-200/60 rounded-2xl hover:border-gray-300 transition-colors">
              <div className="flex items-center gap-3 mb-4">
                 <div className="p-2 bg-[#1871C9]/10 rounded-lg text-[#1871C9]">
                    <Info size={20} />
                 </div>
                 <h4 className="font-serif font-bold text-gray-900">4-5. Informational Nature</h4>
              </div>
            ...
            <motion.div variants={itemVars} className="p-6 bg-gray-200/70 border border-gray-200/60 rounded-2xl hover:border-gray-300 transition-colors">
              <div className="flex items-center gap-3 mb-4">
                 ...
                 <h4 className="font-serif font-bold text-gray-900">6-8. Amendments & Laws</h4>
              </div>
              <p className="text-xs leading-relaxed text-gray-600">
          ...
          <motion.div variants={itemVars} className="p-8 md:p-12 bg-gray-200/70 border border-gray-200/60 rounded-3xl shadow-sm">
            <h3 className="text-gray-900 font-serif font-bold text-2xl mb-6 flex items-center gap-3">
          ...
          <motion.div variants={itemVars} className="p-8 bg-[#1871C9]/5 border border-[#1871C9]/20 rounded-3xl flex flex-col md:flex-row gap-8 items-start backdrop-blur-sm">
            ...
            <div>
              <h3 className="text-gray-900 font-serif font-bold text-xl mb-3">16-18. Linked Websites</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div variants={itemVars} className="p-6 bg-gray-200/50 border border-gray-200/60 rounded-2xl">
              <h4 className="font-bold text-[#1871C9] uppercase text-[10px] tracking-widest mb-3">19. Privacy Integration</h4>
              <p className="text-xs text-gray-600">These terms incorporate and should be read together with the Case Matters Privacy Policy.</p>
            </motion.div>
            <motion.div variants={itemVars} className="p-6 bg-gray-200/50 border border-gray-200/60 rounded-2xl">
              <h4 className="font-bold text-[#1871C9] uppercase text-[10px] tracking-widest mb-3">20. Electronic Messages</h4>
              <p className="text-xs text-gray-600">Expressing interest grants consent for Case Matters to send commercial electronic messages to provided addresses.</p>
            </motion.div>
          </div>
