...
const LawExpandingLayout = () => {
  ...
  const lawBlocks = [
    {
      title: 'Proof & Precision',
      img: propertyLawImage,
    },
    {
      title: 'Dispute Resolution',
      img: criminalJusticeImage,
    },
    {
      title: 'Legal Clarity',
      img: familyLawImage,
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-screen overflow-hidden flex items-center justify-center bg-gradient-to-br from-[#ffffff] via-[#eef6ff] to-[#dcecff]"
    >
      {/* Three Background */}
      <div
        ref={canvasContainer}
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
        {lawBlocks.map((block, i) => (
          ...
          >
            ...
            {/* Black Overlay */}
            <div className="absolute inset-0 bg-black/35 flex flex-col justify-end p-3 sm:p-5 md:p-6">
