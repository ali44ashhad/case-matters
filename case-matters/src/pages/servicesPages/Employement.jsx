  ...
  return (
   <>
    <section ref={container} className="pt-24 pb-12 lg:pt-20 lg:pb-0 relative min-h-screen w-full overflow-hidden bg-white font-sans flex items-center">
      ...
      {/* 3. Main Content Grid */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-20 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
        ...
        <div className="space-y-6 md:space-y-8 order-1 lg:order-1">
          <div ref={carpetRef} className="overflow-hidden">
            <p className="text-[#1871C9] font-bold tracking-[0.2em] uppercase mb-2 md:mb-4 text-sm md:text-base">
              Employment Law
            </p>
            <h1 className="text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter leading-tight lg:leading-[0.95]">
              Advisory & <br />
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link to="/all-services">
                <motion.button 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="rounded-full bg-[#1871C9] px-8 md:px-10 py-3 md:py-4 font-bold text-white shadow-[0_0_20px_rgba(24,113,201,0.3)] transition-all text-sm md:text-base uppercase tracking-wider text-[11px]"
                >
                  Workforce Solutions
                </motion.button>
              </Link>
        ...
        {/* RIGHT BLOCK: Framer Motion Image Card - Mobile Responsive */}
        <motion.div 
        ...
        >
          <div className="relative overflow-hidden rounded-[1.5rem] md:rounded-[2rem] border border-white/10 aspect-[4/3] sm:aspect-[16/10] md:aspect-[4/5] shadow-2xl">
            ...
            <motion.div 
              ...
              className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8 p-4 md:p-6 rounded-xl md:rounded-2xl bg-white/80 border border-white/20 backdrop-blur-xl shadow-lg"
            >
              <p className="text-[#1871C9] text-xs font-bold uppercase tracking-widest">Compliance First</p>
              <p className="text-gray-900 text-sm md:text-lg mt-1 font-medium leading-snug">
          ...
          <div className="absolute -z-10 -top-10 -right-10 w-44 h-44 md:w-72 md:h-72 bg-[#1871C9]/10 blur-[80px] md:blur-[120px] rounded-full" />
        </motion.div>
      </div>
