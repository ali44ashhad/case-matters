  ...
  return (
    <>
      <section ref={container} className="relative min-h-screen w-full overflow-hidden bg-white font-sans flex items-center pt-24 pb-12 lg:pt-20 lg:pb-0">
        ...
        {/* Main Content Grid */}
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-20 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          
          {/* LEFT BLOCK */}
          <div className="space-y-6 md:space-y-8 order-1 lg:order-1">
            <div ref={carpetRef} className="overflow-hidden">
              <h1 className="text-white text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter leading-tight">
                Construction & <br />
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-gray-300 text-base md:text-lg max-w-xl border-l-2 border-[#1871C9]/50 pl-6 italic">
          ...
          {/* RIGHT BLOCK - Responsive Risk Factors Box */}
          <motion.div 
          ...
          >
            <div className="relative overflow-hidden rounded-[1.5rem] md:rounded-[2.5rem] border border-gray-200/30 bg-black/50 backdrop-blur-xl p-5 md:p-10 shadow-2xl">
              <h3 className="text-[#1871C9] text-xs md:text-sm font-bold uppercase tracking-widest mb-4 md:mb-6">Critical Risk Factors</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3 md:gap-4">
                  {[
                    ...
                    <motion.div 
                      ...
                      className="p-4 rounded-xl bg-black/40 border border-white/10 transition-colors"
                    >
                      <p className="text-gray-100 font-bold text-sm md:text-base">{item.title}</p>
                      <p className="text-[11px] md:text-xs text-gray-400 mt-0.5">{item.desc}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
      ...
      <section className="bg-white py-16 md:py-24 px-6 md:px-20 lg:px-32 flex flex-col items-start justify-center min-h-[60vh]">
        <div className="max-w-5xl w-full">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="w-full relative group p-6 md:p-12 border border-gray-200/60 bg-gray-200/70 backdrop-blur-xl rounded-xl md:rounded-none"
          >
            {/* Blue accent line */}
            ...
            <p className="text-gray-700 text-base md:text-xl leading-relaxed font-light text-left">
