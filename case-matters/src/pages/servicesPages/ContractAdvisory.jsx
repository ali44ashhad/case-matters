    ...
    <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6">
            ...
            >
                ...
                <p className="text-sm text-zinc-400 border-l-2 border-[#1871C9]/50 pl-4 italic max-w-lg">
        ...
        >
            ...
            <div className="relative overflow-hidden rounded-2xl border border-[#1871C9]/20 bg-zinc-900/80 p-6 group hover:border-[#1871C9]/50 transition">
                <p className="text-zinc-300 text-sm leading-relaxed">
