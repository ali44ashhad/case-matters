                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="space-y-6 order-1 lg:order-1">
                        ...
                        >
                            ...
                            <p className="text-gray-300 text-sm border-l-2 border-[#1871C9]/50 pl-4 italic max-w-lg">
                            ...
                            <div className="flex flex-wrap gap-3 pt-2">
                                <Link to="/all-services">
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="rounded-full bg-[#1871C9] px-7 py-3 text-sm font-semibold text-white shadow-md uppercase tracking-wider text-[11px]"
                                    >
                                        view services
                                    </motion.button>
                                </Link>
                    ...
                    {/* RIGHT CARDS - Fully Mobile Responsive Wrapper */}
                    <motion.div
                        initial={{ opacity: 0, x: window?.innerWidth < 1024 ? 0 : 40, y: window?.innerWidth < 1024 ? 30 : 0 }}
                        animate={{ opacity: 1, x: 0, y: 0 }}
                        transition={{ duration: 1, delay: 0.4 }}
                        className="relative space-y-4 block order-2 lg:order-2 mt-4 lg:mt-0"
                    >
                        <div className="relative overflow-hidden rounded-xl md:rounded-2xl border border-white/10 bg-black/50 p-5 md:p-6 backdrop-blur-lg">
                        ...
                        <div className="relative overflow-hidden rounded-xl md:rounded-2xl border border-white/10 bg-black/50 p-5 md:p-6 group transition">
                            <p className="text-gray-200 text-sm leading-relaxed">
